...
data modify storage the_sack:storage root.temp.item.tag.the_sack.contents set value []
data modify storage the_sack:storage root.temp.item.tag.display.Lore set value []
...
data modify storage the_sack:storage root.temp.item.tag.display.Lore prepend value '{"translate":"item.the_sack.rummage_sack.lore.3","color":"blue","underlined":true,"italic":false}'
data modify storage the_sack:storage root.temp.item.tag.display.Lore prepend value '{"translate":"item.the_sack.rummage_sack.lore.2","color":"gray","italic":false}'
